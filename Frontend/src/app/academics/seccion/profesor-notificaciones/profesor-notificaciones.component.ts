  ...
  ngOnInit(): void {
    ...
    // funciones esteticas
      ...
      public CambiarComponente( notificacion: any ){
        if (notificacion.evaluacionXEstudianteId && notificacion.tipoNotificacion == 'Calificar'){
          this.cambioDeComponente.emit( { nombre_compoennte: 'evaluar_curso', tipo: notificacion} );
        }
      }
    //////////////////////////////////////////////////////////////////////////////////////////////////////
